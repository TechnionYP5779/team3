...
@SuppressWarnings("boxing") public class boxTests {
  @SuppressWarnings("static-method") @Test public void boxAdds() {
    ...
    final Boolean[] arr1 = { true, false, true };
    for (int i = 0; i < 3; i++)
    ...
    final Double[] arrd1 = { 5.0, 6.1, 7.2 };
    for (int i = 0; i < 3; i++)
    ...
    final Boolean[] ITarr1 = { true, false, true };
    for (int j = 0; j < 3; j++)
    ...
    final Double[] ITarrd1 = { 5.0, 6.1, 7.2 };
    for (int j = 0; j < 3; j++)
    ...
    final Float[] ITarrf1 = { 56f, 50f, 40f };
    for (int j = 0; j < 3; j++)
    ...
    final Integer[] ITarri1 = { 56, 50, 40 };
    for (int j = 0; j < 3; j++)
    ...
    final Long[] ITarrl1 = { 56L, 50L, 40L };
    for (int j = 0; j < 3; j++)
