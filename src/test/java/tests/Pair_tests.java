...
@SuppressWarnings({ "static-access", "unused", "static-method", "boxing" }) public class Pair_tests {
  @Test public void basic_test() {
    final Pair<Integer, String> p = new Pair<>(1, "abc"), p2 = new Pair<>(1, "abc"),
        p3 = new Pair<>(3, "aaaa"), p4 = new Pair<>(1, "ac");
  ...
  @Test public void Pairs_nulls_test() {
    ...
    new Pair<>(3, "aaaa");
    new Pair<>(1, "abc");
    final Pair<Integer, String> p = new Pair<>(1, "abc"), p4 = new Pair<>(1, "ac"), a[] = Pair.makePairs(3),
        b[] = Pair.makePairs(6);
