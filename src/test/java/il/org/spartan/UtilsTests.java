...
@SuppressWarnings( "static-method" )  public class UtilsTests {
  ...
  @Test public void test2() {
    ...
    @NotNull String[] arr3= {"1","2","3"};
    Utils.swap(arr3, 0, 2);
    assert(arr3[0].equals("3"));
    assert(new Utils.FoundHandleForT<>("1") != null);
    Utils.FoundHandleForT<String> t= new Utils.FoundHandleForT<>("1");
    assert(t.in("1"));
    assert(t.in("2")==false);
    assert(new FoundHandleForInt(1) != null);
    FoundHandleForInt t1= new FoundHandleForInt(1);
    assert(t1.in(1));
