...
public class Rectangle {
  ...
  @SuppressWarnings({ "rawtypes", "unchecked"}) public Rectangle(double x1 ,double y1 , double x2 ,double y2){
  ...
  @SuppressWarnings({ "rawtypes", "unchecked" }) public void changeFirst(double x1, double y1) {
    first=new Pair(box.box(x1),box.box(y1));
    
  }
  @SuppressWarnings({ "rawtypes", "unchecked"}) public void changeSecond(double x2, double y2) {
    second=new Pair(box.box(x2),box.box(y2));
