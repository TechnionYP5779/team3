...
public class Rectangle {
  ...
  @SuppressWarnings({ "rawtypes", "unchecked", "boxing" }) public Rectangle(final double x1, final double y1, final double x2, final double y2) {
  ...
  @SuppressWarnings({ "rawtypes", "unchecked", "boxing" }) public void changeFirst(final double x1, final double y1) {
    first = new Pair(x1, y1);
  }

  @SuppressWarnings({ "rawtypes", "unchecked", "boxing" }) public void changeSecond(final double x2, final double y2) {
    second = new Pair(x2, y2);
  }
